...
MATERIAL_TOPICS = {
    ...
    ToolType.PRODUCT_SCENE: [
        ...
        {"id": "seasonal", "name_en": "Seasonal", "name_zh": "季節主題"},
        {"id": "holiday", "name_en": "Holiday", "name_zh": "節日主題"},
    ],
    ToolType.TRY_ON: [
        {"id": "casual", "name_en": "Casual Wear", "name_zh": "休閒服飾"},
        {"id": "formal", "name_en": "Formal Wear", "name_zh": "正式服飾"},
        {"id": "sportswear", "name_en": "Sportswear", "name_zh": "運動服飾"},
        {"id": "outerwear", "name_en": "Outerwear", "name_zh": "外套"},
        {"id": "accessories", "name_en": "Accessories", "name_zh": "配飾"},
        {"id": "dresses", "name_en": "Dresses", "name_zh": "連衣裙"},
    ],
    ...
    ToolType.SHORT_VIDEO: [
        ...
        {"id": "tutorial", "name_en": "Tutorial", "name_zh": "教學影片"},
        {"id": "promo", "name_en": "Promotion", "name_zh": "促銷廣告"},
    ],
    ToolType.AI_AVATAR: [
