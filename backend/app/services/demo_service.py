...
# Demo topics for each category - SMB-focused content for small-medium businesses
# These prompts target Taiwan SMB use cases: food, daily products, stores, social ads
DEMO_TOPICS = {
    "food_drinks": [
        "Bubble tea being poured with ice and tapioca pearls",
        "Crispy fried chicken on a takeout tray",
        "Steaming beef noodle soup in a bowl",
        "Fresh fruit smoothie with straw",
        "Artisan coffee latte art in ceramic cup",
        "Night market grilled sausage on stick",
        "Bento lunch box with colorful dishes",
        "Fresh baked pineapple cake on plate",
        "Handmade mochi on bamboo plate",
        "Cold brew tea in glass bottle",
    ],
    "daily_products": [
        "Handmade soap bars on wooden shelf",
        "Stainless steel thermos bottle studio shot",
        "Herbal shampoo bottle with green leaves",
        "Cotton towels stacked neatly",
        "Essential oil diffuser with warm light",
        "Bamboo toothbrush set eco-friendly",
        "Canvas tote bag on table",
        "Scented candle in glass jar",
        "Ceramic tea set on wooden tray",
        "Natural lip balm with kraft packaging",
    ],
    "store_scenes": [
        "Cozy neighborhood cafe interior",
        "Night market food stall with steam",
        "Bakery display window with fresh bread",
        "Small clothing boutique storefront",
        "Tea shop with wooden shelves of tea canisters",
        "Flower shop entrance with colorful bouquets",
        "Pet supply shop display",
        "Stationery store organized shelves",
        "Hair salon modern interior",
        "Juice bar counter with fresh fruits",
    ],
    "social_ads": [
        "Product flat lay on marble for Instagram",
        "Before-after skincare comparison",
        "Unboxing scene with tissue paper",
        "Hand holding product against pastel background",
        "Product arranged with seasonal flowers",
        "Lifestyle scene with product in daily use",
        "Gift set packaging for holiday promotion",
        "Customer using product naturally",
        "Product next to a cup of coffee",
        "Simple product on clean white background",
    ],
}
