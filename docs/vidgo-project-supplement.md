...
| **推薦裂變成長** | 推薦人獲得 50 點、新用戶獲得 40 點，形成低成本病毒式獲客機制 |
| **跨境電商切入** | 8 大核心 AI 工具加上付費室內 3D 匯出，覆蓋電商視覺生產需求（商品去背、場景合成、試穿、室內設計、短影片、Avatar 等），對中小型電商賣家有強烈降本吸引力 |
...
| 階段 | 目標 | 關鍵功能 |
|------|------|----------|
| **MVP（已完成）** | 8 大核心工具、付費牆、信用系統 | PRESET + REAL-API 雙模式、Paddle 金流 |
...
| **電商專用工具** | **8 大核心工具 + 3D 匯出（去背、試穿、室內 3D 等）** | 無 | 無 | 部分（去背） | 部分（去背） | 無 |
...
1. **服務創新**：為電商垂直市場設計的 8 大核心工具一站式 AI 視覺生產平台，並提供付費室內 3D 匯出
