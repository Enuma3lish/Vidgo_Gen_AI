...
/**
 * InvoiceCheckoutDialog — collect the buyer's e-invoice choice at ECPay
 * checkout time (載具 / 統編+公司抬頭 / 捐贈), then hand it back to the parent.
 *
 * The parent saves it via einvoiceApi.updatePreferences BEFORE redirecting to
 * ECPay; the existing post-payment auto_issue_invoice then issues exactly what
 * the buyer picked here. "Skip" proceeds to payment without changing the saved
 * preference (falls back to whatever default they already have).
 */
