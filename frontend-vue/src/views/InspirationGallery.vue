...
const CURATED_FALLBACK_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    title_zh: '北歐風客廳改造',
    prompt: 'Redesign the room in Nordic style with wooden furniture, natural light, and a crisp warm palette. Unfurnished by people — pure interior render.',
    prompt_zh: '將空間改為北歐風，木質家具與自然採光，清爽暖色調。無人入鏡的純室內提案渲染。',
  ...
  {
    id: 'fallback-room-2',
    title: 'Japandi bedroom proposal',
    title_zh: '日式侘寂臥室提案',
    prompt: 'Quiet bedroom render in Japandi style — pale ash wood, linen bedding, paper lantern, single bonsai on a raw-edge bench. No people.',
    prompt_zh: '日式侘寂臥室提案渲染：淺色梣木、亞麻寢具、紙燈籠、原木邊几上一盆盆景。畫面中沒有人。',
    image_url: 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=900&q=80',
    tool_type: 'room_redesign',
    topic: 'room_redesign',
    tags: ['interior', 'bedroom', 'japandi', 'design'],
    type: 'image',
  },
  {
    id: 'fallback-room-3',
    title: 'Modern minimalist kitchen render',
    title_zh: '現代極簡廚房渲染',
    prompt: 'Modern minimalist kitchen — matte handle-less cabinets, marble island, integrated appliances, soft daylight. Empty room, no people.',
    prompt_zh: '現代極簡廚房：無把手霧面櫃體、大理石中島、嵌入式家電，柔和日光。空房間，無人入鏡。',
    image_url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=900&q=80',
    tool_type: 'room_redesign',
    topic: 'room_redesign',
    tags: ['interior', 'kitchen', 'minimalist', 'design'],
    type: 'image',
  },
  {
    id: 'fallback-room-4',
    title: 'Industrial loft living room',
    title_zh: '工業風 Loft 客廳',
    prompt: 'Industrial loft living room — exposed brick, steel beams, leather sofa, warm tungsten lighting. Architectural render, no people.',
    prompt_zh: '工業風 Loft 客廳：紅磚牆、鋼樑、皮革沙發、暖色鎢絲燈。建築渲染，畫面中沒有人物。',
    image_url: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?auto=format&fit=crop&w=900&q=80',
    tool_type: 'room_redesign',
    topic: 'room_redesign',
    tags: ['interior', 'living_room', 'industrial', 'design'],
    type: 'image',
  },
  {
    id: 'fallback-room-5',
    title: 'Empty balcony staging proposal',
    title_zh: '陽台虛擬陳設提案',
    prompt: 'Stage an empty balcony into a Japanese-zen reading nook — low cypress bench, paper lantern, single ikebana arrangement. No people.',
    prompt_zh: '空陽台改為日式禪風閱讀角：低矮檜木長椅、紙燈籠、單盆花藝。畫面中沒有人。',
    image_url: 'https://images.unsplash.com/photo-1513694203232-719a280e022f?auto=format&fit=crop&w=900&q=80',
    tool_type: 'room_redesign',
    topic: 'room_redesign',
    tags: ['interior', 'balcony', 'staging', 'design'],
    type: 'image',
  },
  {
    id: 'fallback-room-6',
    title: 'Hotel-style luxury bathroom',
    title_zh: '飯店級奢華浴室提案',
    prompt: 'Luxury hotel bathroom — book-matched marble, brushed brass fixtures, freestanding tub by frosted window. Architectural render, no people.',
    prompt_zh: '飯店級奢華浴室：對紋大理石、刷面黃銅五金、磨砂窗旁的獨立浴缸。建築渲染，畫面中沒有人物。',
    image_url: 'https://images.unsplash.com/photo-1552321554-5fefe8c9ef14?auto=format&fit=crop&w=900&q=80',
    tool_type: 'room_redesign',
    topic: 'room_redesign',
    tags: ['interior', 'bathroom', 'luxury', 'design'],
    type: 'image',
  },
  {
    id: 'fallback-video-1',
