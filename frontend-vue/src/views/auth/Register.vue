      ...
      <div class="relative z-10">
        ...
        <div class="space-y-3">
          <div class="flex items-center gap-2.5">
            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style="background: rgba(82,196,26,0.15);">
              <svg class="w-3 h-3" style="color: #52c41a;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
            </div>
            <span class="text-sm" style="color: rgba(0,0,0,0.65);">{{ t('auth.perk1') }}</span>
          </div>
          <div class="flex items-center gap-2.5">
            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style="background: rgba(82,196,26,0.15);">
              <svg class="w-3 h-3" style="color: #52c41a;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
            </div>
            <span class="text-sm" style="color: rgba(0,0,0,0.65);">{{ t('auth.perk2') }}</span>
          </div>
          <div class="flex items-center gap-2.5">
            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style="background: rgba(82,196,26,0.15);">
              <svg class="w-3 h-3" style="color: #52c41a;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
            </div>
            <span class="text-sm" style="color: rgba(0,0,0,0.65);">{{ t('auth.perk3') }}</span>
          </div>
          <div class="flex items-center gap-2.5">
            <div class="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style="background: rgba(82,196,26,0.15);">
              <svg class="w-3 h-3" style="color: #52c41a;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"/></svg>
            </div>
            <span class="text-sm" style="color: rgba(0,0,0,0.65);">{{ t('auth.perk4') }}</span>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="flex-1 flex items-center justify-center px-4 py-16 sm:px-8">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl p-8 md:p-10" style="box-shadow: 0 4px 24px rgba(0,0,0,0.08); border: 1px solid rgba(0,0,0,0.06);">
          <h1 class="text-2xl font-bold mb-1" style="color: #1F1F1F;">{{ t('auth.registerTitle') }}</h1>
          <p class="text-sm mb-6" style="color: rgba(0,0,0,0.45);">{{ t('auth.registerSubtitle2') }}</p>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium mb-1.5" style="color: #1F1F1F;">{{ t('auth.setPassword') }}</label>
              <div class="relative">
          ...
          <p class="text-xs text-center mt-4" style="color: rgba(0,0,0,0.35);">
            {{ t('auth.termsAgree') }}
          </p>
          ...
          <div class="flex items-center gap-3 my-6">
            ...
            <span class="text-xs" style="color: rgba(0,0,0,0.35);">{{ t('auth.hasAccount') }}</span>
            <div class="flex-1 h-px" style="background: rgba(0,0,0,0.08);"></div>
          </div>
