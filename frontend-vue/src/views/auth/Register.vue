    ...
    <div class="w-full max-w-md relative z-10">
      <div class="rounded-3xl p-8 md:p-10"
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-2xl font-bold mb-2" style="color: #e8f4ff;">免費開始創作</h1>
          <p class="text-sm" style="color: #6b9ab8;">立即獲得 40 點免費點數</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <button type="submit" :disabled="isLoading"
            ...
            <span>{{ isLoading ? '註冊中...' : '免費開始 — 獲得 40 點' }}</span>
          </button>
        </form>
        ...
        <div class="flex items-center gap-3 my-6">
          ...
          <span class="text-xs" style="color: #4a7bb5;">已有帳號？</span>
          <div class="flex-1 h-px" style="background: rgba(0,184,230,0.15);"></div>
        </div>
