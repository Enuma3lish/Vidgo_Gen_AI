...
const task = useGenerationTask('sketch_to_render')
...
async function generate() {
  ...
  let result: any
  try {
    result = await task.run((cid) => toolsApi.roomRedesign(url, selectedStyle.value, customPrompt.value.trim() || undefined, undefined, undefined, {
